...
export function Logo(props: LogoProps) {
  const { label = true, color = 'white', size = 'normal' } = props;
  ...
  return (
    <svg
      ...
      viewBox={`0 0 ${label ? 158 : 58} 48`}
      className={clsx({
        [styles.root]: size === 'normal',
        [styles.root__large]: size === 'large',
        [styles.root__unlabeled]: !label,
      })}
    >
      <path
      ...
      {label ? (
        <path
          ...
          className={clsx({
            [styles.text__white]: color === 'white',
            [styles.text__black]: color === 'black',
          })}
        />
      ) : null}
      <defs>
