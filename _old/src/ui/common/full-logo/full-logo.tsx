...
import { fullLogoSva } from "@/ui/common/full-logo/full-logo.sva";
...
export function FullLogo(props: FullLogoProps) {
  const { color = "black", size = "normal" } = props;

  const pathId = useId();
  const fullLogoClasses = fullLogoSva({ color, size });
  ...
  return (
    <svg
      ...
      className={fullLogoClasses.root}
    ...
    >
      ...
      <path
        ...
        className={fullLogoClasses.label}
      ></path>
      <defs>
        <linearGradient
          id={pathId}
