...
export function FullLogo(props: FullLogoProps) {
  const { color = "black", size = "normal", style } = props;
  const pathId = useId();

  // Define dimensions based on size
  const dimensions = {
    normal: { width: 126, height: 49 }, // 7.875rem * 16, 3.063rem * 16
    large: { width: 200, height: 60 }, // 12.5rem * 16, 3.74rem * 16
  };
  ...
  return (
    ...
    >
      ...
      <Path
        ...
        strokeLinecap="round"
      />
      <Ellipse rx="1.506" ry="1.5" cx="44.723" cy="13.66" fill="#0A0D27" />
      <Ellipse rx="1.506" ry="1.5" cx="49.743" cy="17.603" fill="#0A0D27" />
      <Ellipse rx="1.506" ry="1.5" cx="44.723" cy="21.603" fill="#0A0D27" />
      <Ellipse rx="1.506" ry="1.5" cx="39.703" cy="17.603" fill="#0A0D27" />
      <Path
